...
def main():
    ...
    # 공격자산 
    SPY = pdr.get_data_yahoo('SPY', start_day, end_day)['Adj Close'] 
    VEA = pdr.get_data_yahoo('VEA', start_day, end_day)['Adj Close'] 
    EEM = pdr.get_data_yahoo('EEM', start_day, end_day)['Adj Close'] 
    AGG = pdr.get_data_yahoo('AGG', start_day, end_day)['Adj Close'] 

    # 수비자산 
    LQD = pdr.get_data_yahoo('LQD', start_day, end_day)['Adj Close'] 
    SHY = pdr.get_data_yahoo('SHY', start_day, end_day)['Adj Close'] 
    IEF = pdr.get_data_yahoo('IEF', start_day, end_day)['Adj Close']
